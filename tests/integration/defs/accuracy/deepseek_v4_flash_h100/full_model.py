...
REQUIRED_PATTERNS = (
    ...
    # The routed-expert contract the SM90 path resolves. Named to the exact
    # algo rather than to "MXFP4": the packed layout is the same bytes under
    # W4A16 and W4A8, and it is the *activation* half of the contract this
    # bring-up had to correct, so a silent revert to W4A16_MXFP4 has to fail
    # here rather than pass a looser pattern.
    ("routed_moe_mxfp4_w4a8", r"routed MoE.*MXFP4 W4A8_MXFP4_FP8"),
)
